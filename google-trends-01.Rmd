...
Other/standard settings for markdown:
...
* afaik, no way to specify these variations within the gtrendsR/API query
* CAN use the encoded variation of the term shown in the browser
...
So the above is easy way to work with individual terms.

### Set query parameters

```{r}
srch_term <- c("covid-19","climate change")
period <- "today 3-m"
...
Returns bundle of same 7 data frames, with data for each search term within them:
